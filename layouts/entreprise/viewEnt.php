                        ...
                        <div class="">
                              ...
                              <div class="card text-center">
                                    ...
                                    <div class="card-body">
                                          ...
                                          <div class="mb-3 row">
                                                <label for="staticEmail" class="col-sm-2 col-form-label">Nombre
                                                      etudiants Cesi</label>
                                                <div class="col-sm-10">
                                                      <input class="form-control" type="text"
                                                            value="<?= $row['nombre_etudiant'] ?>"
                                                            placeholder="Disabled input"
                                                            aria-label="Disabled input example" disabled>
                                                </div>
                                          ...
                                          <div class="mb-3 row">
                                                <label for="staticEmail" class="col-sm-2 col-form-label">Région</label>
                                                <div class="col-sm-10">
                                                      <input class="form-control" type="text"
                                                            value="<?= $row['région'] ?>" placeholder="Disabled input"
                                                            aria-label="Disabled input example" disabled>
                                                </div>
                                          ...
                                          <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-10">
                                                      <input class="form-control" type="text"
                                                            value="<?= $row['ville'] ?>" placeholder="Disabled input"
                                                            aria-label="Disabled input example" disabled>
                                                </div>
                                          ...
                                          <div class="mb-3 row">
                                                <div class="mb-3 row">
                                                      <label for="staticEmail" class="col-sm-2 col-form-label">Code
                                                            Postal
                                                      </label>
                                                      <div class="col-sm-10">
                                                            <input class="form-control" type="text"
