 ...
 <form action="insertionsample.php" method="post">
   <div class="row"> 
    ...
    <div class="row"> 
        ...
        <div class="col colproright">
            <label for="FormInput" class="form-label" id="Compte">Entreprise</label>
            <input type="text" class="form-control " id="exampleFormControlInput1" name="Entreprise" placeholder="">
        </div>   
    </div>
