...
//creation entreprise
$creation_secteur_activite= $my_Db_Connection->prepare("INSERT INTO ( nom, photo_profil, validite, nombre_etudiant  ) VALUES (:nom, :photo_profil , :validite , :nombre_etudiant  )");
...
//creating avoir 
$avoir_creation=$my_Db_Connection->prepare("INSERT INTO ( id_secteur, id_entreprise  ) VALUES ( :id_secteur,:id_entreprise )");
...
//recuperating the ville id
 if($ville_creation->execute())
 {
    ...
    $id_ville_created=$my_Db_Connection->lastInsertId();
}
